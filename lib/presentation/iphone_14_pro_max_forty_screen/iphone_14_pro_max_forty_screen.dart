...
class Iphone14ProMaxFortyScreen extends StatefulWidget {
  ...
  @override
  State<Iphone14ProMaxFortyScreen> createState() =>
      _Iphone14ProMaxFortyScreenState();
}
...
class _Iphone14ProMaxFortyScreenState extends State<Iphone14ProMaxFortyScreen> {
  ...
  Widget build(BuildContext context) {
    //Color _iconColor = Colors.green[900];
                  ...
                  Container(
                      ...
                      child: Column(mainAxisSize: MainAxisSize.min, children: [
                        ...
                        Align(
                            ...
                            child: Padding(
                                padding:
                                    EdgeInsets.only(top: 13.v, right: 20.h),
                                child: Row(children: [
                                  Padding(
                                      ...
                                      child: Column(
                                          ...
                                          children: [
                                            ...
                                            SizedBox(
                                                width: 174.h,
                                                child: Text(
                                                    "It is used for animal rearing ,wound healing.",
                                                    maxLines: 3,
                                                    overflow:
                                                        TextOverflow.ellipsis,
                                                    style: CustomTextStyles
                                            ...
                                            SizedBox(
                                                width: 199.h,
                                                child: Text(
                                                    "It might cause eugenol overdose.",
                                                    maxLines: 2,
                                                    overflow:
                                                        TextOverflow.ellipsis,
                                                    style: CustomTextStyles
