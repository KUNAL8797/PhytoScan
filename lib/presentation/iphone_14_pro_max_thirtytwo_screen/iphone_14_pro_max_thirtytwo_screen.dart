...
class Iphone14ProMaxThirtytwoScreen extends StatefulWidget {
  ...
  @override
  State<Iphone14ProMaxThirtytwoScreen> createState() =>
      _Iphone14ProMaxThirtytwoScreenState();
}

class _Iphone14ProMaxThirtytwoScreenState
    extends State<Iphone14ProMaxThirtytwoScreen> {
  bool isGreen = true;
  void _toggleColor() {
    setState(() {
      isGreen = !isGreen;
                ...
                child: SingleChildScrollView(
                  ...
                  Container(
                      ...
                      child: Column(mainAxisSize: MainAxisSize.min, children: [
                        ...
                        Padding(
                            padding: EdgeInsets.only(top: 15.v, right: 3.h),
                            child: Row(
                                mainAxisAlignment:
                                    MainAxisAlignment.spaceBetween,
                                children: [
                                  ...
                                  Column(
                                      ...
                                      children: [
                                        ...
                                        SizedBox(
                                            width: 184.h,
                                            child: Text(
                                                "Betel leaves are used as a stimulant,an antiseptic",
                                                maxLines: 3,
                                                overflow: TextOverflow.ellipsis,
                                                style: CustomTextStyles
                                                    .titleLargePrimaryContainer)),
                                        ...
                                        SizedBox(
                                            width: 206.h,
                                            child: Text(
                                                "It slows down the heart beat rate.",
                                                maxLines: 2,
                                                overflow: TextOverflow.ellipsis,
                                                style: CustomTextStyles
                                                    .titleLargePrimaryContainer)),
